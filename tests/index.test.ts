...
describe('instantiate client', () => {
  ...
  test('with environment variable arguments', () => {
    ...
    process.env['PAPR_PYTHON_SDK_API_KEY'] = 'My API Key';
    process.env['PAPR_PYTHON_SDK_BEARER_TOKEN'] = 'My Bearer Token';
    const client = new Papr();
  ...
  test('with overridden environment variable arguments', () => {
    // set options via env var
    process.env['PAPR_PYTHON_SDK_API_KEY'] = 'another My API Key';
    process.env['PAPR_PYTHON_SDK_BEARER_TOKEN'] = 'another My Bearer Token';
    const client = new Papr({ apiKey: 'My API Key', bearerToken: 'My Bearer Token' });
    expect(client.apiKey).toBe('My API Key');
    expect(client.bearerToken).toBe('My Bearer Token');
  });
