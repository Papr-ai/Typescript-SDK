...
[![NPM version](https://img.shields.io/npm/v/papr-python-sdk.svg)](https://npmjs.org/package/papr-python-sdk) ![npm bundle size](https://img.shields.io/bundlephobia/minzip/papr-python-sdk)
...
```sh
npm install git+ssh://git@github.com:stainless-sdks/papr-python-sdk-typescript.git
```

> [!NOTE]
> Once this package is [published to npm](https://app.stainless.com/docs/guides/publish), this will become: `npm install papr-python-sdk`
...
const client = new Papr({
  apiKey: process.env['PAPR_PYTHON_SDK_API_KEY'], // This is the default and can be omitted
  bearerToken: process.env['PAPR_PYTHON_SDK_BEARER_TOKEN'], // This is the default and can be omitted
});
...
```ts
import Papr from 'npm:papr-python-sdk';
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/papr-python-sdk-typescript/issues) with questions, bugs, or suggestions.
