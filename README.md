...
```sh
npm install git+ssh://git@github.com:Papr-ai/Typescript-SDK.git
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/Papr-ai/Typescript-SDK/issues) with questions, bugs, or suggestions.
